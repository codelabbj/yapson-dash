...
import OperatorsStatus from "@/app/(dasboard)/operator/page";
...
const menuGroups = [
  {
    ...
    menuItems: [
      ...
      {
        icon: <Bell />,
        label: "Expéditeur de Notifications",
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <ClickOutside onClick={() => setSidebarOpen(false)}>
      <aside
        className={`fixed left-0 top-0 z-50 flex h-screen w-59 flex-col overflow-y-hidden bg-black duration-300 ease-linear dark:bg-boxdark lg:translate-x-0 ${
